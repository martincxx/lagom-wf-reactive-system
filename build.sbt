...
lagomCassandraEnabled in ThisBuild := true //changed to true to test

lagomUnmanagedServices in ThisBuild := Map("d" -> "http://localhost:9042")

lagomKafkaEnabled in ThisBuild := true //changed to true to test
